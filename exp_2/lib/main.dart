...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'IT Department',
      home: Scaffold(
        backgroundColor: Color.fromARGB(255, 37, 27, 27),
        appBar: AppBar(
          leading: Builder(
          ...
          style: TextStyle(
          fontWeight: FontWeight.bold,),),
          backgroundColor: Color.fromARGB(255, 67, 34, 73),
        ),
        body: Builder(
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          backgroundColor: Color.fromARGB(255, 212, 126, 179),
          content: Text(
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          backgroundColor: Color.fromARGB(255, 211, 166, 181),
          content: Column(
            children: [
              Text(
